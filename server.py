                    ...
                    "parts": [
                        {
                            "text": (f"Based on the following data: Total Emissions: {total_emissions} tons CO2, "
                                     ...
                                     f"Emission Reduction of {emission_reduction}%, provide suggestions and pathways "
                                     ...
                                     "description, category, cost analysis and recommendations. every property should have bullet point and every property should start from new line  Each recommendation should be a "
